...
que realicé el año pasado, la cuál era también en sistemas distribuidos. Para recordar
...
comunicación mediante mensajes disponible en múltiples languages, entre ellos, Node. Es
...
que todos los hoyos hayan recibido el mensaje una vez por lo menos sea muy alta.
...
funcionamiento que los paquetes TCP-IP), delta es la duración de cada ronda, y nextBall es la próxima BALL
o conjunto de eventos próximo a enviar.
...
de ordenación y se reinicia a conjunto vacío para la próxima ronda.
...
aunque dice también que puede funcionar con un reloj lógico perfectamente, y explica cómo.
